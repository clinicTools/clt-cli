<template>
    <Header>
        <Toolbar :compressed="true">
            <template #start>
                <Buttons>
                    <ion-menu-toggle menu="start" auto-hide="false">
                        <Button type="icon" @click="toggleMenu">
...
export default {
    ...
    ,methods: {
        ...
        async toggleMenu(e) {
            let splitPane = document.querySelector("ion-split-pane");
